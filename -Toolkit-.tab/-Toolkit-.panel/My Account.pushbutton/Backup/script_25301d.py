...
from System.Windows import Window, WindowStyle
from System.Windows.Controls import TextBlock, StackPanel, Button, Image
...
from System.Windows import FontWeights, Thickness, HorizontalAlignment, Input
...
def show_message_with_link():
    ...
    image.Cursor = Input.Cursors.Hand
    ...
    window.WindowStyle = WindowStyle.None  # Hides the border and title bar
    window.AllowsTransparency = True  # Makes the window background transparent
    window.ShowDialog()
